...
export const PROJECT_PROPERTIES = {
  ...
  // People - Team Members rollup properties
  DEVELOPER: { id: '%5Cm%3Am', name: 'Developer', type: 'relation' },
  LEAD_DEVELOPER: { id: 'PuHX', name: 'Lead Developer', type: 'relation' },
  QUALITY_INSPECTOR: { id: 'CsfV', name: 'Quality Inspector', type: 'relation' },
  DESIGNER: { id: 'IQ%7CL', name: 'Designer', type: 'relation' },
